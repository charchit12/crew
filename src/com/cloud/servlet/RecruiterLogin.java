...
public class RecruiterLogin extends HttpServlet {
    ...
    static Logger logger = Logger.getLogger(RecruiterLogin.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        if (errorMsg != null) 
        {
            ...
            request.setAttribute("action", "RecruiterLogin");
        ...
        else 
        {
            ...
            try 
            {
               ps = con.prepareStatement("select email, name, password from recruiter where email='" + email + "' and password='" + password + "'");
               rs = ps.executeQuery();
                if (rs != null) 
                {
                    ...
                    else 
                    {
                        ...
                        RequestDispatcher rd = getServletContext().getRequestDispatcher("/Rlogin.html");
                        rd.include(request, response);
                    }
                } 
                else 
